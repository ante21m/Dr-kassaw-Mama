...
const staticIntents: Record<string, { keys: string[]; tKey: string; links?: { labelKey: string; href: string }[] }> = {
  ...
  about: {
    keys: ["mama hospital", "dr kassaw", "medhin primary hospital", "hospital", "clinic", "about", "tell me", "who are you", "ማማ ሆስፒታል", "ዶር ካሳው", "ዶ/ር ካሳው ማማ ፕራይመሪ ሆስፒታል", "ክሊኒክ", "ሆስፒታል", "ስለ", "ንገረኝ", "ስለምን ማወቅ ይፈልጋሉ"],
    tKey: "ai.about",
    links: [
      { labelKey: "ai.lServices", href: "/services" },
      { labelKey: "ai.lDepartments", href: "/departments" },
