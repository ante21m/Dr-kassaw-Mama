...
const copy = {
  en: {
    ...
    values: [
      ...
      { icon: "🤝", title: "Community Trust", desc: "Built on years of trusted service to the Woldia community.", stat: "Serving since 2024" },
  ...
  am: {
    ...
    storyLabel: "ታሪካችን",
    storyTitle: "እኛ ማን ነን",
    cards: [{ title: "መሰረታችን" }, { title: "ጉዟችን" }, { title: "መድኅን ዛሬ" }],
    vmLabel: "ዓላማ",
    missionKicker: "ተልዕኮ",
    visionKicker: "ራዕይ",
    values: [
      { icon: "❤️", title: "ርህራሔ ቅድሚያ ይሰጣል", desc: "እያንዳንዱ ታካሚ በክብር፣ በደግነት እና በእኩልነት ይስተናገዳል።", stat: "ታካሚ ተኮር እንክብካቤ" },
      { icon: "🏥", title: "የላቀ የሕክምና ብቃት", desc: "ዓለም አቀፍ ደረጃውን የጠበቀ ሕክምና የሚሰጡ ባለሙያ ስፔሻሊስቶች።", stat: "50+ ስፔሻሊስቶች" },
      { icon: "🤝", title: "የማኅበረሰብ እምነት", desc: "ለወልድያ ማኅበረሰብ ለዓመታት ከተሰጠ የታመነ አገልግሎት የተገነባ።", stat: "ከ2024 እ.ኤ.አ. ጀምሮ የሚያገለግል" },
      { icon: "🔬", title: "ዘመናዊ ሕክምና", desc: "በላቁ የምርመራ መሳሪያዎችና ቴክኖሎጂ ላይ የሚደረግ ቀጣይነት ያለው ኢንቨስትመንት።", stat: "24/7 የድንገተኛ ሕክምና አገልግሎት" },
    ],
    journeyLabel: "ጉዟችን",
    journeyTitle: "የእንክብካቤ ማይልስቶኖች (ታሪካዊ አጋጣሚዎች)",
    timeline: [
      { year: "2024", title: "መጀመሪያው", desc: "መድኅን የመጀመሪያ ደረጃ ሆስፒታል በወልድያ በሩን የከፈተው በአንድ ቃል ኪዳን ነው — ጥራት ያለው የጤና እንክብካቤ በቅርብዎ።" },
      { year: "ዕድገት", title: "አገልግሎቶችን ማስፋፋት", desc: "አዳዲስ የሕክምና ክፍሎች፣ ተጨማሪ ስፔሻሊስቶች እና ሰፋ ያሉ የሕክምና አገልግሎቶች የማገልገል አቅማችንን አሳድገውታል።" },
      { year: "ቴክኖሎጂ", title: "ዘመናዊ የምርመራ አገልግሎት", desc: "በዘመናዊ የላቦራቶሪ እና የኢሜጂንግ (ምስል) ቴክኖሎጂ ላይ የተደረገው ኢንቨስትመንት ፈጣንና የበለጠ ትክክለኛ ምርመራዎችን ለማስገኘት አስችሏል።" },
      { year: "24/7", title: "ሁልጊዜ ክፍት", desc: "የድንገተኛ ሕክምና ክፍላችን አይዘጋም — እያንዳንዱ ደቂቃ ዋጋ በሚኖራት ጊዜ የ24 ሰዓት ድንገተኛ ሕክምና እንክብካቤ እንሰጣለን።" },
      { year: "ዛሬ", title: "የታመነ ስም", desc: "በአካባቢው ተመራጭና የታመነ የጤና አገልግሎት አቅራቢ በመሆን ይታወቃል — አሁንም በርህራሔ እና በሙያዊ ብቃት የሚመራ።" },
    ],
